...
function nokri_register_required_plugins()
{
    ...
    $plugins = array(
		...
		array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => 'https://downloads.wordpress.org/plugin/add-to-any.1.7.34.zip',
            'is_callable' => ''
        ),
		...
		array(
			...
			'external_url'       => esc_url( 'https://downloads.wordpress.org/plugin/woocommerce.3.5.5.zip'
